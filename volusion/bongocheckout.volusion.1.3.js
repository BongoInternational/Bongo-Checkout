/*		
	...
	1.3 - Switch use of jQuery to no conflict
...
function getCustInfo() {
	...
	custInfo['country_2letteriso'] = countryCode($b('form[name="form"] select[name="ShipCountry"]').val());
...
function showShippingInfo() {
	...
	$b('form[name="form"] input[name="btnRecalculate"]').css("visibility", "hidden");
}
...
function hideShippingInfo() {
	...
	$b('form[name="form"] input[name="btnRecalculate"]').css("visibility", "visible");
}
...
function intlShippingInfo() {
	...
	$b('form[name="form"] select[name="ShipCountry"]').parent().parent().parent().parent().parent().append('<div id="intlShippingInfo"><p><b>International Customers!</b><br />Shipping duties, taxes, and fees will be assessed on the next page.</p></div>');
