...
var BongoCheckout = {
	...
	message_abovebutton_bg_color: '#e6e6e6',
	...
	message_belowshipping_bg_color: '#e6e6e6',
...
*/
	...
	insertForm: function() {
		...
		for (i=0; i < itemIDs.length; i++) {
			...
			if (this.per_item_shipping) {
				...
				$b('form[name="BongoCheckoutForm"]').append('<input type="hidden" name="PRODUCT_SHIPPING_'+(i+1)+'" value="'+this.shipping_cost.toString()+'"> ');
			} else {
				
				$b('form[name="BongoCheckoutForm"]').append('<input type="hidden" name="PRODUCT_SHIPPING_'+(i+1)+'" value="'+shipping_cost_breakdown+'"> '); // The value here needs to be non-zero
			}
		}
	},
	...
	insertNotice: function() {
		...
		var content = '<div id="BongoCheckoutNotice" style="margin:5px; padding:5px; background:'+this.message_belowshipping_bg_color+'; border:1px solid '+this.message_belowshipping_border_color+';"><p><b><font style="color:red;">International Customers!</font> Don\'t see your country?</b><br />'+this.message_belowshipping+'</p></div>';
