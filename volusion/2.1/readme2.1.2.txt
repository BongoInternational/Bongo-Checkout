Volusion Implementation Guide v2.1.1
------------------------------------
...
1. Edit bongocheckout.volusion.2.1.1.js and on line 23 enter your PARTNER_KEY.
2. Using the File Manager or via FTP, upload bongocheckout.volusion.2.1.1.js to your vspfiles folder.         
...
<script type="text/javascript" src="v/vspfiles/bongocheckout.volusion.2.1.1.js"></script>
